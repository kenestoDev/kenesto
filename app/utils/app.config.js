export const config = {
    ...
    urls: [{ env : 'dev',
         Ip: '10.0.0.14',
         ApiBaseUrl : 'http://10.0.0.14/Kenesto.Web.API/', 
         AuthUrlTemplate: 'http://10.0.0.14/Kenesto.Web.API/Access.svc/Authenticate/json/{2}?u={0}&p={1}',
         LoginUrlTemplate: 'http://10.0.0.14/Kenesto.Web.API/Access.svc/Login/json/{0}?t={1}',
         ForgotPasswordUrl: 'http://10.0.0.14/Kenesto.Web.API/Access.svc/ForgotPassword/json?u={0}',
    },          
    {
         env : 'devDudu',
         Ip: '10.0.0.125',
    ...
    },
   {
        env : 'pisx',
         Ip: '10.0.0.114',
         ApiBaseUrl : 'http://app.pisx.com/Kenesto.Web.API/', 
         AuthUrlTemplate: 'http://app.pisx.com/Kenesto.Web.API/Access.svc/Authenticate/json/{2}?u={0}&p={1}',
         LoginUrlTemplate: 'http://app.pisx.com/Kenesto.Web.API/Access.svc/Login/json/{0}?t={1}',
         ForgotPasswordUrl: 'https://app.pisx.com/Kenesto.Web.API/Access.svc/ForgotPassword/json?u={0}',
         
    },
   {
        env : 'qa',
         Ip: '10.0.0.117',
         ApiBaseUrl : 'https://play.kenesto.com/Kenesto.Web.API/', 
         AuthUrlTemplate: 'https://play.kenesto.com/Kenesto.Web.API/Access.svc/Authenticate/json/{2}?u={0}&p={1}',
         LoginUrlTemplate: 'https://play.kenesto.com/Kenesto.Web.API/Access.svc/Login/json/{0}?t={1}',
         ForgotPasswordUrl: 'https://play.kenesto.com/Kenesto.Web.API/Access.svc/ForgotPassword/json?u={0}',
