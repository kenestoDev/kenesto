...
export default {
  ...
  openMainApp: (appGroupId) => NativeModules.ReactNativeShareExtension.openMainApp(appGroupId),
  deleteTempFiles: (appGroupId) => NativeModules.ReactNativeShareExtension.deleteTempFiles(appGroupId),
}